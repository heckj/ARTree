...
// ClickGesture to capture location (in local coordinate space by default) of where the click happened.
// sourced from StackOverflow:
// https://stackoverflow.com/questions/66463987/get-mouse-pointer-position-for-tap-gestures-in-swiftui-for-macos-apps
//
